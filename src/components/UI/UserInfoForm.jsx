      ...
      <div className='flex flex-col items-center mt-20 drop-shadow-xl'>
            <div className="border px-9 rounded-3xl bg-white flex flex-col items-center pb-4 pt-5" >
               ...
               <form className='w-full flex flex-col' onSubmit={send}>
                  ...
                  <div className="flex contacts mt-8">
                     <div className="flex flex-col w-4/12">
                        ...
                        <div id='phone' className=" border-y-2 rounded-full bg-white align-top text-gray-600 focus:ring-gray-600 focus:outline-gray-400 h-fit drop-shadow-sm font-xl flex w-full">
                           ...
                           <input className=" font-semibold pl-1 mr-3 my-2 focus:outline-none w-full" name = "phone" placeholder="" required/>
                        </div>
                     </div>
                  ...
                  <button className="  hover:drop-shadow-[0_3px_3px_rgba(0,0,0,0.8)] drop-shadow-sm rounded-full px-16 py-2 mt-14 text-white bg-gradient-to-r from-sky-700 via-sky-600 to-sky-700 text-lg font-semibold mx-auto ">Отправить</button>
               </form>
